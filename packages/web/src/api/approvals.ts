...
export const getApprovalCountSummaryQueryKey = (params?: GetApprovalCountSummaryParams,) => {
    return [`/metrics/approvals/count/summary`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getApprovalCountSummaryQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof approvalCountSummary>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getApprovalCountSeriesQueryKey = (params?: GetApprovalCountSeriesParams,) => {
    return [`/metrics/approvals/count/series`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getApprovalCountSeriesQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof approvalCountSeries>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getApprovalCountSeriesByApproverQueryKey = (approverId: number,
    params?: GetApprovalCountSeriesByApproverParams,) => {
    return [`/metrics/approvals/count/series/by/approver/${approverId}`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getApprovalCountSeriesByApproverQueryKey(approverId,params);
   ...
   return  { queryKey, queryFn, enabled: !!(approverId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof approvalCountSeriesByApprover>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getApproverSummaryQueryKey = (params?: GetApproverSummaryParams,) => {
    return [`/metrics/approvals/approver/summary`, ...(params ? [params]: [])] as const;
    }

    
export const getApproverSummaryInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof approverSummary>>, GetApproverSummaryParams['page']>, TError = ErrorType<unknown>>(params?: GetApproverSummaryParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof approverSummary>>, TError, TData, Awaited<ReturnType<typeof approverSummary>>, QueryKey, GetApproverSummaryParams['page']>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getApproverSummaryQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseInfiniteQueryOptions<Awaited<ReturnType<typeof approverSummary>>, TError, TData, Awaited<ReturnType<typeof approverSummary>>, QueryKey, GetApproverSummaryParams['page']> & { queryKey: QueryKey }
}
...
export function useApproverSummaryInfinite<TData = InfiniteData<Awaited<ReturnType<typeof approverSummary>>, GetApproverSummaryParams['page']>, TError = ErrorType<unknown>>(
 params: undefined |  GetApproverSummaryParams, options: { query:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof approverSummary>>, TError, TData, Awaited<ReturnType<typeof approverSummary>>, QueryKey, GetApproverSummaryParams['page']>> & Pick<
        DefinedInitialDataOptions<
...
export function useApproverSummaryInfinite<TData = InfiniteData<Awaited<ReturnType<typeof approverSummary>>, GetApproverSummaryParams['page']>, TError = ErrorType<unknown>>(
 params?: GetApproverSummaryParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof approverSummary>>, TError, TData, Awaited<ReturnType<typeof approverSummary>>, QueryKey, GetApproverSummaryParams['page']>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof approverSummary>>,
          TError,
          TData, QueryKey
...
export function useApproverSummaryInfinite<TData = InfiniteData<Awaited<ReturnType<typeof approverSummary>>, GetApproverSummaryParams['page']>, TError = ErrorType<unknown>>(
 params?: GetApproverSummaryParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof approverSummary>>, TError, TData, Awaited<ReturnType<typeof approverSummary>>, QueryKey, GetApproverSummaryParams['page']>>, }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getApproverSummaryQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof approverSummary>>, TError, TData> & { queryKey: QueryKey }
}
