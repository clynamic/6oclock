...
import { ManifestHealthController } from './manifest-health.controller';
...
@Module({
  ...
  providers: [ManifestHealthService],
  exports: [ManifestHealthService],
})
export class ManifestHealthModule {}
