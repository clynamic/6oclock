 ...
 */
import type { ModeratorMoveFavoritesBodyCommit } from './moderatorMoveFavoritesBodyCommit';

export interface ModeratorMoveFavoritesBody {
  commit: ModeratorMoveFavoritesBodyCommit;
}
