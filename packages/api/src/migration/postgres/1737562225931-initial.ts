...
export class Initial1737562225931 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "permits" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "post_id" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_e0f39993461b6ea160b4f42ac1c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dd9ef5a04ed4a0bf79bf3a7219" ON "permits" ("post_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."manifests_type_enum" AS ENUM('approvals', 'tickets', 'posts', 'users', 'user_profiles', 'flags', 'feedbacks', 'post_versions', 'post_replacements', 'mod_actions')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "flags" ("id" integer NOT NULL, "creator_id" integer NOT NULL, "post_id" integer NOT NULL, "is_resolved" boolean NOT NULL, "reason" text NOT NULL, "type" "public"."flags_type_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "label_id" text, CONSTRAINT "REL_86d80e82fac1719346cf803a55" UNIQUE ("label_id"), CONSTRAINT "PK_ea7e333c92a55de9e9b8d0b9afd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "approvals" ("id" integer NOT NULL, "post_id" integer NOT NULL, "user_id" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "label_id" text, CONSTRAINT "REL_6ec666fa54dc79a0f4c695c217" UNIQUE ("label_id"), CONSTRAINT "PK_690417aaefa84d18b1a59e2a499" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "approvals" ADD CONSTRAINT "FK_6ec666fa54dc79a0f4c695c2176" FOREIGN KEY ("label_id") REFERENCES "labels"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "approvals" DROP CONSTRAINT "FK_6ec666fa54dc79a0f4c695c2176"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8f36a17c106cce6b46cb193cb4"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2565bad45a3e088f09587b63d6"`,
    );
